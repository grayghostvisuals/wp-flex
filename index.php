    ...
    <section>
      ...
      <article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
        <header>
          ...
          <h1 class="post-title"><span><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?> blog post entry"><?php the_title(); ?></a></span></h1>
          
          <small class="post-copyright"> <span class="post-author"></span><time class="post-datetime" datetime="%3$s" pubdate><?php the_time( get_option( 'date_format' ) ); ?></time></small> 
          </header>
        ...
        <footer class="post-footer">
          <div class="post-comments"><span class="comments-link"><a href="<?php comments_link(); ?>"><?php comments_number( '0', '1', '%' ); ?>Comments</a></span></div>
