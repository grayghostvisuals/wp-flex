...
<style>#wpflex-header { background: url(<?php header_image(); ?>) }</style><?php }//end function wpflex_header_style

// gets included in the admin header
function wpflex_admin_header_style() { ?>
<style>#wpflex-headimg { width:  <?php echo HEADER_IMAGE_WIDTH; ?>px; height: <?php echo HEADER_IMAGE_HEIGHT; ?>px; background: no-repeat }</style> <?php } //end function wpflex_admin_header_style
